...
% full-width inline banners, never clip off the page
...
\lstdefinestyle{common}{%
  ...
  xrightmargin=-8pt, framexrightmargin=0pt,
...
\input{sections/10-probability}
\newpage

\input{sections/20-brainteasers}
\newpage

\input{sections/30-code}
\newpage

\input{sections/40-style_reference}
