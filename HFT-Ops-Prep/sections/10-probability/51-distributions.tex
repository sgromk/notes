...
As a note on the lognormal entry, the right tail is heavy enough that $\E[e^{tX}]$ diverges for every $t > 0$, which is a compact example of a distribution that has all moments yet no MGF.
\end{keybox}
